...
| jt053260 (Konami K053260) | https://github.com/jotego/jtcores (modules/jt053260) | jt053260.v/_channel.v/_timer.v; jtframe_limsum.v from modules/jtframe/hdl/sound | GPL-3.0. 4 channels, each with its own ROM port; all served from one PSRAM window by a round-robin fetcher in the chipbox arbiter |
