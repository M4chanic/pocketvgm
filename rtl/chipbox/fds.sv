...
module fds (
  ...
  // Приводим к 16 битам со знаком; сам fout не превышает 63*32 = 2016.
  assign snd = master_vol == 2'd0 ? fout
             : master_vol == 2'd1 ? (fout * 16'sd2) / 16'sd3
             : master_vol == 2'd2 ? (fout / 16'sd2)
                                  : (fout * 16'sd2) / 16'sd5;
