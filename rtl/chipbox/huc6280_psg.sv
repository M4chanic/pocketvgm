...
module huc6280_psg (
  ...
  wire [4:0] vl_i = ch_mute ? 5'd31 : (al_raw > 7'd31 ? 5'd31 : al_raw[4:0]);
  wire [4:0] vr_i = ch_mute ? 5'd31 : (ar_raw > 7'd31 ? 5'd31 : ar_raw[4:0]);
    ...
    if (rst) begin
      ...
      if (scan_q2 == 3'd5) begin
        ...
        snd_left  <= acc_l > 18'sd32767 ? 16'sd32767
                   : acc_l < -18'sh8000 ? -16'sh8000 : acc_l[15:0];
        snd_right <= acc_r > 18'sd32767 ? 16'sd32767
                   : acc_r < -18'sh8000 ? -16'sh8000 : acc_r[15:0];
      end
    end
  end
